...
export default function Navbar() {
  ...
  const doSearch = useDebounce(async (term) => {
    const response = await fetch(`http://localhost:8000/v2/search?q=${term}`);
    if (!response.ok) {
    ...
    addData(data.result);
    console.log("search resule", data.result);
}, 500);
  ...
  // console.log('n data from navabr',nData);
  return (
    <>
      <nav className="border-b border-black py-6 md:py-8">
        <div className="container mx-auto flex flex-wrap items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-3 lg:space-x-8">
            <input
              ...
              className="w-64 h-10 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500"
              placeholder="Search"
            />{" "}
        ...
        <div className="container mx-auto mt-6">
          <ul className="flex flex-wrap items-center justify-center gap-5 text-xs font-semibold lg:text-base">
            <li>
              <a onClick={() => handelCategory("")} href="#">
                General
              </a>
            </li>
            <li>
              <a onClick={() => handelCategory("business")} href="#">
                Business
              </a>
            </li>
            <li>
              <a onClick={() => handelCategory("entertainment")} href="#">
                Entertainment
              </a>
            </li>
            <li>
              <a onClick={() => handelCategory("health")} href="#">
                Health
              </a>
            </li>
            <li>
              <a onClick={() => handelCategory("science")} href="#">
                Science
              </a>
            </li>
            <li>
              <a onClick={() => handelCategory("sports")} href="#">
                Sports
              </a>
            </li>
            <li>
              <a onClick={() => handelCategory("technology")} href="#">
                Technology
              </a>
            </li>
          </ul>
